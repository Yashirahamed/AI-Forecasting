  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative px-4 py-12">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-1/3 right-1/3 w-96 h-96 rounded-full opacity-10"
          style={{ background: 'radial-gradient(circle, #a78bfa, transparent 70%)', filter: 'blur(60px)' }} />
        <div className="absolute bottom-1/3 left-1/3 w-80 h-80 rounded-full opacity-10"
          style={{ background: 'radial-gradient(circle, #38bdf8, transparent 70%)', filter: 'blur(50px)' }} />
      </div>
      ...
      >
        <div className="glass rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-7">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl mb-4 glow-purple"
              style={{ background: 'linear-gradient(135deg, #a78bfa, #38bdf8)' }}>
              <span className="text-2xl">🚀</span>
            </div>
            <h1 className="text-2xl font-bold text-white mb-1">Create your account</h1>
            <p className="text-slate-400 text-sm">Join WeatherCast AI today</p>
          </div>
          ...
          <p className="text-center text-sm text-slate-400 mt-6">
            {t('auth.hasAccount')}{' '}
            <Link to="/login" className="text-[#38bdf8] hover:underline font-medium">
              {t('auth.signIn')}
            </Link>
          </p>
        </div>
